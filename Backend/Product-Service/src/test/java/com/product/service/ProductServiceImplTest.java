...
@SpringBootTest(classes={com.product.ProductServiceApplication.class})
...
class ProductServiceImplTest {
    ...
    static void init() {
        ...
        products.add(new Product("1", "Product1", "Type1", "Category1", null, 1200.0, "TestProduct1"));
        products.add(new Product("2", "Product2", "Type2", "Category2", null, 1900.0, "TestProduct2"));
        products.add(new Product("3", "Product3", "Type1", "Category2", null, 300.0, "TestProduct3"));
        products.add(new Product("4", "Product4", "Type3", "Category3", null,  300.0, "TestProduct4"));
    }
    ...
    void updateProduct() {
        Product updateProduct = new Product("4", "UpdatedProduct4", "Type3", "Category3", null, 300.0, "UpdateTestProduct4");
    ...
    void addProduct() {
        Product newProduct = new Product("5", "newProduct", "Type3", "Category3", null,  300.0, "newTestProduct5");
